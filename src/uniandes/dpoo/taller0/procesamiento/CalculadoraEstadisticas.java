...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Indica el pais al cual representó un atleta
	 * 
	 * 
	 * @return El pais representado por el atleta ingresado como
	 *        parametro 
	 */
	...
	public String paisPorAtleta(String nombreAtleta)
	{
		...
		if (elAtleta != null)
		{
			Pais pais_atleta = elAtleta.darPais();
			resultado=pais_atleta.darNombre();
		}
