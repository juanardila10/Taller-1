...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Informar el pais de un atleta dado");
	...
	/**
	 * Este método le pide al usuario el nombre de un atleta
	 * y retorna el nombre del pais al cual representó dicho atleta
	 */
	private void ejecutarInformarPais()
	{
		System.out.println("\n" + "País al que pertenece " + "\n");
		String atleta = input("Ingrese el nombre del atleta de interés");
		String pais = calculadora.paisPorAtleta(atleta);
		if (pais!=null)
			System.out.println("\n" + "El país al que pertenece "+atleta+" es "+pais);
		else
			System.out.println("\n"+ "No se encontró un atleta con el nombre de "+atleta);
